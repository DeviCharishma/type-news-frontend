...
function App() {
	...
	const getNewsArticles = async () => {
		const api_call = await fetch(`https://charishmab.pythonanywhere.com/`);
			...
			return (
				<div>
					<div className="header">
						...
						<strong className="subtitle" style={{paddingTop: 100, paddingRight: 50, fontWeight: 600}}>- By Charishma B</strong>
					</div>
